# Took here. Expanding basic createsuperuser, adding --password
# and --preserve to check if superuser already exist
# https://github.com/adamcharnock/swiftwind-heroku/
# blob/master/swiftwind_heroku/management/commands/
